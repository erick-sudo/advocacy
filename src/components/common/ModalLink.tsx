    ...
    <div className="">
      ...
      >
        ...
        <Modal.Body className="p-0">
          <div>
            <div className="p-4 relative">{modalContent}</div>
            <div className="grid grid-cols-2 gap-4 mt-4 px-4 py-3 border-t border-gray-800/50 ">
              <ScaleButton
                as="button"
                onClick={handleClose}
                text={cancelText}
                className={`flex-grow hover:scale-100 hover:-translate-y-2 py-2 hover:bg-amber-800 hover:text-white duration-300 ${cancelButtonClassName}`}
              />
              <ScaleButton
                onClick={() => {
                  submitData();
                ...
                {...{
                  ...
                  className: `flex-grow hover:scale-100 hover:-translate-y-2 py-2 hover:bg-amber-800 hover:text-white duration-300 ${submitButtonClassName}`,
                }}
              />
            </div>
          </div>
