...
import { capitalize, utilityFunctions } from "../../assets/functions";
...
export default function Case({ casex, selectedCase, setSelectedCase }) {
  return (
    <div
      ...
      className={`relative group odd:bg-white hover:bg-amber-100 hover:font-bold duration-500 cursor-pointer items-center border-b border-amber-800/25`}
    >
      ...
      <div className="flex items-center flex-grow p-2">
        <div className="min-w-[2rem] max-w-[2rem] flex z-20">
          ...
          <div className="z-20 px-2">
            <div className="flex flex-wrap items-center">
              <span className="text-gray-600 font-bold">
                <span
                  className={`mx-2 text-xs bg-amber-900 text-white rounded p-1`}
                >
                  {casex.id}
                </span>{" "}
                {casex.title}
...
export function CaseDetails({ casex = {}, setLoading }) {
